...
class RedisCache
{
    ...
    private function __construct($host = '127.0.0.1', $port = 6379, $auth = false, $timeout = 120)
    {
        $this->redis = new \Redis();
        $this->port = $port ?: 6379;
        $this->host = $host ?: '127.0.0.1';
        $this->auth = $auth ?: false;
        $this->cachetime = $timeout ?: false;
        $this->redis->connect($this->host, $this->port, $this->cachetime);
        ...
        $this->expireTime = time() + $this->cachetime;
    }
